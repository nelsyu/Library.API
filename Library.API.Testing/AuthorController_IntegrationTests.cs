...
{
    //public class AuthorController_IntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    public class AuthorController_IntegrationTests : IClassFixture<CustomWebApplicationFactory<Program>>
    {
        //private readonly WebApplicationFactory<Program> _factory;
        private readonly CustomWebApplicationFactory<Program> _factory;
        private readonly LoginUser _loginUser;

        //public AuthorController_IntegrationTests(WebApplicationFactory<Program> factory)
         public AuthorController_IntegrationTests(CustomWebApplicationFactory<Program> factory)
        {
            _factory = factory;
        ...
        public async Task Test_GetAuthorById(string authorId)
        {
            ...
            Assert.Equal("application/json; charset=utf-8; v=1.0", response.Content.Headers.ContentType?.ToString());
