...
namespace Library.API.Testing
{
    public class AuthorController_UnitTests
    {
        ...
        public AuthorController_UnitTests()
        {
            ...
            _authorController = new AuthorController(_mockRepositoryWrapper.Object, _mockMapper.Object, _mockLogger.Object, _mockHashFactory.Object, _mockDistributedCache.Object);
